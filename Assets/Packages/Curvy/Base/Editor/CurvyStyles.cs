        ...
        public static GUIStyle ModuleWindow
        {
            get
            {
                if (mModuleWindow == null)
                {
                    ...
                    mModuleWindow.normal.background = CurvyResource.Load((EditorGUIUtility.isProSkin) ? "cgwindowdark,64,64" : "cgwindowlight,64,64");
                    mModuleWindow.onNormal.background = CurvyResource.Load((EditorGUIUtility.isProSkin) ? "cgwindowdark1,64,64" : "cgwindowlight1,64,64");
